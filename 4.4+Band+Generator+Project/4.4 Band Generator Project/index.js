...
//  var randomNum = adj[Math.floor(Math.random()*adj.length)];
//  var randomNum2 = noun[Math.floor(Math.random()*noun.length)];

  //scroll down to see the two arrays.
  res.render("index.ejs", {adj:randomSuperhero(), noun: randomSuperhero()});
